...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months: "sr-flex sr-flex-col sm:sr-flex-row sr-space-y-4 sm:sr-space-x-4 sm:sr-space-y-0",
        month: "sr-space-y-4",
        caption: "sr-flex sr-justify-center sr-pt-1 sr-relative sr-items-center",
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeftIcon className="sr-h-4 sr-w-4" />,
        IconRight: ({ ...props }) => <ChevronRightIcon className="sr-h-4 sr-w-4" />,
      }}
      {...props}
    />
  )
