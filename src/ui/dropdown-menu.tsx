...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "sr-flex sr-cursor-pointer sr-select-none sr-items-center sr-rounded-sm sr-px-2 sr-py-1.5 sr-text-sm sr-outline-none focus:sr-bg-accent data-[state=open]:sr-bg-accent",
      inset && "sr-pl-8",
      className
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "sr-relative sr-flex sr-cursor-pointer sr-select-none sr-items-center sr-rounded-sm sr-px-2 sr-py-1.5 sr-text-sm sr-outline-none sr-transition-colors focus:sr-bg-accent focus:sr-text-accent-foreground data-[disabled]:sr-pointer-events-none data-[disabled]:sr-opacity-50",
      inset && "sr-pl-8",
      className
    )}
    {...props}
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "sr-relative sr-flex sr-cursor-pointer sr-select-none sr-items-center sr-rounded-sm sr-py-1.5 sr-pl-8 sr-pr-2 sr-text-sm sr-outline-none sr-transition-colors focus:sr-bg-accent focus:sr-text-accent-foreground data-[disabled]:sr-pointer-events-none data-[disabled]:sr-opacity-50",
      className
    )}
    checked={checked}
    {...props}
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn("sr-ml-auto sr-text-xs sr-tracking-widest sr-opacity-60", className)}
      {...props}
    />
  )
}
