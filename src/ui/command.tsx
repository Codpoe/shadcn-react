...
>(({ className, ...props }, ref) => (
  <div className="sr-flex sr-items-center sr-border-b sr-px-3" cmdk-input-wrapper="">
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.List
    ref={ref}
    className={cn("sr-max-h-[300px] sr-overflow-y-auto sr-overflow-x-hidden", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "sr-relative sr-flex sr-cursor-pointer sr-select-none sr-items-center sr-rounded-sm sr-px-2 sr-py-1.5 sr-text-sm sr-outline-none aria-selected:sr-bg-accent aria-selected:sr-text-accent-foreground data-[disabled]:sr-pointer-events-none data-[disabled]:sr-opacity-50",
      className
    )}
    {...props}
  />
