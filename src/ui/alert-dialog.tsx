...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      "sr-fixed sr-inset-0 sr-z-50 sr-bg-black/80 data-[state=open]:sr-animate-in data-[state=closed]:sr-animate-out data-[state=closed]:sr-fade-out-0 data-[state=open]:sr-fade-in-0",
      className
    )}
    {...props}
    ref={ref}
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("sr-text-lg sr-font-semibold", className)}
    {...props}
  />
))
