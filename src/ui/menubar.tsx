...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      'sr-flex sr-cursor-default sr-select-none sr-items-center sr-rounded-sm sr-px-3 sr-py-1 sr-text-sm sr-font-medium sr-outline-none focus:sr-bg-accent focus:sr-text-accent-foreground data-[state=open]:sr-bg-accent data-[state=open]:sr-text-accent-foreground',
      className,
    )}
    {...props}
  />
...
>(({ className, inset, children, ...props }, ref) => (
  <MenubarPrimitive.SubTrigger
    ref={ref}
    className={cn(
      'sr-flex sr-cursor-default sr-select-none sr-items-center sr-rounded-sm sr-px-2 sr-py-1.5 sr-text-sm sr-outline-none focus:sr-bg-accent focus:sr-text-accent-foreground data-[state=open]:sr-bg-accent data-[state=open]:sr-text-accent-foreground',
      inset && 'sr-pl-8',
      className,
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Item
    ref={ref}
    className={cn(
      'sr-relative sr-flex sr-cursor-default sr-select-none sr-items-center sr-rounded-sm sr-px-2 sr-py-1.5 sr-text-sm sr-outline-none focus:sr-bg-accent focus:sr-text-accent-foreground data-[disabled]:sr-pointer-events-none data-[disabled]:sr-opacity-50',
      inset && 'sr-pl-8',
      className,
    )}
    {...props}
...
>(({ className, children, checked, ...props }, ref) => (
  <MenubarPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      'sr-relative sr-flex sr-cursor-default sr-select-none sr-items-center sr-rounded-sm sr-py-1.5 sr-pl-8 sr-pr-2 sr-text-sm sr-outline-none focus:sr-bg-accent focus:sr-text-accent-foreground data-[disabled]:sr-pointer-events-none data-[disabled]:sr-opacity-50',
      className,
    )}
    checked={checked}
    {...props}
